...
int Web_Server(void)
{
    ...
    USART1_printf(USART1, "enc28j60 reversion: %d\r\n", rev);

    /*{
        char mac_test[6];

        mac_test[0]=enc28j60Read(MAADR5);
        mac_test[1]=enc28j60Read(MAADR4);
        mac_test[2]=enc28j60Read(MAADR3);
        mac_test[3]=enc28j60Read(MAADR2);
        mac_test[4]=enc28j60Read(MAADR1);
        mac_test[5]=enc28j60Read(MAADR0);

        for(int i=0; i<6; i++)
            USART1_printf(USART1, "mac_test[%d]=%d\r\n", i, mac_test[i]);
